...
const tableRouter = {
  ...
  children: [
    ...
    {
      path: 'NEW_editableProTable',
      component: () => import('@/views/table/NEW_editableProTable.vue'),
      name: 'NEW_editableProTable',
      meta: { title: '练习-可编辑表格', keepAlive: true, icon: 'MenuIcon' },
    },
    // {
    //     path: 'multi-table',
